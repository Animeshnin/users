...
export const User = ({id, email, first_name, last_name, avatar, onClickAddInvted, isInvited}) => (
  <li>
    <div>
    ...
    <img onClick={() => onClickAddInvted(id)} className="action" src={`/assets/${isInvited? 'minus' : 'plus' }.svg`} alt="Action" />
  </li>
);
